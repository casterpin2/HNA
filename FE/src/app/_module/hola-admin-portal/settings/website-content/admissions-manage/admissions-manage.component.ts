...
@Component({
  selector: 'app-admissions-manage',
  templateUrl: './admissions-manage.component.html',
  styleUrls: ['./admissions-manage.component.scss']
})
export class AdmissionsManageComponent implements OnInit {
  total = 1;
  listOfCourse: any[];
  loading = true;
  pageSize = 10;
